    ...
    class IntCodeComputer
    {
        ...
        public void Run()
        {
            ...
            while (!end)
            {
                ...
                else if (opcodeInstruction == "99") { end = true; }
        ...
        {
            long parameter1 = GetValueFromMode(currentOpcodeIndex + 1, 2);
            Console.WriteLine($"The output is : ({parameter1})");
            currentOpcodeIndex += 2;
        }
